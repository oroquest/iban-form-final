// netlify/functions/iban_check.js  — production version (no dummy data)
// - Reads id, token, em/email from body, query, or referer
// - Fetches Mailjet contact data by email and validates token_iban (+ optional expiry)
// - Returns readonly (filtered) + props_all
...
exports.handler = async (event) => {
  try {
    ...
    // Build readonly: filter out tokens/iban/ip/agent; we keep only user-facing props
    const readonly = {};
